		...
		Animate.prototype = {
			...
			roll: function (time) {
				...
				ul.css({
					...
					'-webkit-transition': '-webkit-transform ' + time / 4000 + 's ' + this.easing,
					'-ms-transform': 'translateX(' + left + 'px)',
					'-ms-transition': '-ms-transform ' + time / 4000 + 's ' + this.easing,
					'transform': 'translateX(' + left + 'px)',
					'transition': 'transform ' + time / 4000 + 's ' + this.easing,
				});
